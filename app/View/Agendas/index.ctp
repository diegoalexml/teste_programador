<div class="agendas index">
	...
	<tr>
		...
		<td><?php echo h($agenda['Agenda']['titulo']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $agenda['Agenda']['id']), array(), __('Are you sure you want to delete # %s?', $agenda['Agenda']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
